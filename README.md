...
- **Commercial & Private Use**: You are free to use this tool for any project, including private or closed-source mods. You are **not** required to open-source your own project.
- **Credit Required**: You **must** provide visible credit to **VocalOpal** in your mod's documentation, credits file, or in-game screen if you use assets generated by this tool.
